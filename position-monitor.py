...
def quick_scan():
    ...
    os.system('cd /root/.openclaw/workspace && TELEGRAM_BOT_TOKEN=8531470868:AAFGiL0bo1O57FAjXRmGTW0ZZrYE3hb0ZB8 python3 binance-scanner.py >> /root/.openclaw/workspace/scanner.log 2>&1')
